...
The model prompt/configuration is versioned and hashed by the V2 runner. Invalid model intents and ungrounded moves become canonical clarification/refusal outcomes.
